...
## Flutter Web Automation Strategy
...
1. Use `gog mail list --query "from:noreply@bcbsglobalsolutions.com verification code" --max 1` to get the latest code
2. Look for a 6-digit number in the email body
3. Enter the code into the `textbox` matching "code|otp|2fa|verif"
